...
def load_dataset(benchmark, datapath, thres, device, split='test', 
                 augmentation=False, feature_size=16, aug_mode=None, 
                 aug_aff_scaling=None, aug_tps_scaling=None, aug_photo_weak = None, 
                 aug_photo_strong= None, aug_photo_source=0.2, additional_weak=False):
    ...
    return dataset(benchmark, datapath, thres, device, split, 
                   augmentation, feature_size, aug_mode, 
                   aug_aff_scaling, aug_tps_scaling, aug_photo_weak, 
                   aug_photo_strong, aug_photo_source=aug_photo_source, additional_weak=additional_weak)
